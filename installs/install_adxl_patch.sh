...
#     curl -sSL https://raw.githubusercontent.com/<USER>/<REPO>/main/install.sh | sh -s -- install
#     curl -sSL https://raw.githubusercontent.com/<USER>/<REPO>/main/install.sh | sh -s -- status
#     curl -sSL https://raw.githubusercontent.com/<USER>/<REPO>/main/install.sh | sh -s -- update
#     curl -sSL https://raw.githubusercontent.com/<USER>/<REPO>/main/install.sh | sh -s -- uninstall
#
...
REPO_RAW="${REPO_RAW:-https://raw.githubusercontent.com/CHANGE_ME/CHANGE_ME/main}"
...
preflight() {
    ...
    case "$REPO_RAW" in
        *CHANGE_ME*)
            die "REPO_RAW is not configured. Edit install.sh and set the GitHub raw URL, or run with REPO_RAW=https://... sh install.sh"
            ;;
    esac
}
...
Examples:
  curl -sSL <url>/install.sh | sh
  curl -sSL <url>/install.sh | sh -s -- status
  curl -sSL <url>/install.sh | sh -s -- uninstall
  REPO_RAW=https://raw.githubusercontent.com/me/myfork/main \\
    sh install.sh install
EOF
}
