...
for required in gen_belts_for_guppy.sh gen_shaper_for_guppy.sh _shaper_with_figsize.py shaper_json_emitter.py graph_belts.py; do
...
info "    shaper_json_emitter.py  (JSON output for GuppyScreen parser)"
